...
(
	...
	CONSTRAINT FK_USER_POSITION FOREIGN KEY (position) REFERENCES POSITION(id_position)
);
...
(
	...
	CONSTRAINT FK_PURCHASE_ORDER FOREIGN KEY(id_order) REFERENCES ORDER(id_order),
